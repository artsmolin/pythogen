...
class BaseMetricsIntegration:
    def __init__(
        ...
        self._client_response_time_histogram = client_response_time_histogram or Histogram(
        ...
        self._client_non_http_errors_counter = client_non_http_errors_counter or Counter(
